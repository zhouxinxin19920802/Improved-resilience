    ...
    def step(self, actions):    
        ...
        if self.is_visual:
            ...
            self.ax.quiver(x_temp_f, y_temp_f, x_temp_dot_f,
                           y_temp_dot_f,
                           width=0.01, scale=5, units="inches", color='#0000FF', angles='xy')
        ...
        if not evaluation:
            ...
            # print("total_step:",self.total_steps, " connect_value:", connect_value, " arrival_rate:", arrival_rate)
                ...
                with open("destination_nums_xu.txt","a+") as space:
                    space.write(str(count_fn)+"\n") 
                with open("destination_nums_xu_leader.txt","a+") as space1:
...
if __name__ == '__main__':
    ...
    file_path_destination_leader = "destination_nums_xu_leader.txt"
    try:
        ...
        delete_file_if_exists(file_path_destination_leader)
    except OSError as e:
        print(f"删除文件时发生错误: {e}")
