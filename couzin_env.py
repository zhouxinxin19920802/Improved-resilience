    ...
    def step(self, actions):
        ...
        if not evaluate:
            ...
            if self.total_steps >= 2000:
                ...
                with open("destination_nums1.txt","a+") as space1:
                    space1.write(str(count_fn_leader)+"\n") 
        ...
        if(all(done)==True and self.space_time_flag == True) or (self.space_time_flag == True and count_fn > 0):
            ...
            # 写入空间复杂度和时间复杂度
            with open("space_complexity_r.txt","a+") as space:
                space.write(str(space_complexity)+"\n") 
            with open("time_complexity_r.txt","a+") as space:
